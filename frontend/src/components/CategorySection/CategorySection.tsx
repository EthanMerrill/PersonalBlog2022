...
const CategorySection = (props: IcategorySection) => {
	...
	return (
		<>
			<h2 className={"dynamicTitle rounded-lg sticky mt-16 sm:mt-2 mb-0 dt" + sectionNumber + " animate-fadeSlow" + sectionNumber + (hover ? " hover" : "")}>
				<a href={"#" + encodeURI(title)}>{title}</a>
			</h2>
