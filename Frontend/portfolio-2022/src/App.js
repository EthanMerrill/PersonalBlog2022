              ...
              <div className='h-[70vh] contain-paint '>
                ...
                <div className='sticky bottom-36 w-full '>
                  <div className=' text-white mx-auto w-1/5 text-center'>
                    ...
                    <a href="mailto:eth22mer@gmail.com"><div className='solid border-[1.5px] rounded border-white w-40 h-1/2 mx-auto my-3 text-white text-center p-2'>Drop me a line!</div></a>
